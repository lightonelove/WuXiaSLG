...
namespace Wuxia.GameCore
{
    ...
    {
        [Header("UI元件連結")] [Tooltip("行動順序圖示的Prefab")] [SerializeField]
        private GameObject turnOrderIconPrefab;

        [Tooltip("用來放置所有圖示的容器物件 (需掛載Horizontal Layout Group)")] [SerializeField]
